...
export default (): Router => {
    ...
    app.post("/:id", isLogged, hasRole('Waiter'), async (req, res) => {
        ...
        if(req.body.new_customers !== null && req.body.new_customers <= table.seats) table.customers = req.body.new_customers;
        if(req.body.new_occupied !== null)  table.occupied = req.body.new_occupied;
